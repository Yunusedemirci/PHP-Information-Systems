...
if (isset($_POST['lesson'])) {
    if (!empty($_POST['lesson'])) {
        ...
        $sucsess = $lessonController->lessonAdd($lesson, $teacher);
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                    data-bs-target="#profile-overview">Adding Lessons</button>
                            </li>

                            <li class="nav-item">
                                <button id="userview" class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#profile-edit">View Lessons</button>
                            </li>
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="lesson" type="text" class="form-control" id="name" value="">
                                        </div>
                                    </div>
                                    <?php 
                  $userController = new userController();
                  ...
                  ?>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary">Adding Lessons</button>
                                    </div>
                                    <?php
                  if ($sucsess) {
                ...
                if(isset($_POST['search'])){
                    if(!empty($_POST['searchInput'])){
                        ...
                        $lessons = $lessonController->searchLessons($search);
                        ...
                        <table class="table table-striped table-hover">
                          ...
                          foreach($lessons as $lesson){
                            ...
                            <td>'.$lesson->teacher_user_id.'</td>
                            <td>
                            <a href="lessonedit.php?id='.$lesson->id.'" class="btn btn-sm btn-primary">Edit</a>
                            <a href="delete.php?lessonid='.$lesson->id.'" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                            </tr>';
                          }
                            echo '</tbody>
