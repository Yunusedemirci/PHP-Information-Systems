...
if (isset($_POST['examscore'])) {
  ...
  $examController->examUpdate($id,$examscore);
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                    data-bs-target="#profile-overview">Adding Exams</button>
                            </li>

                            <li class="nav-item">
                                <button id="userview" class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#profile-edit">View Exams</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                <form action="#" method="post">
                                    <?php 
                    $userController = new userController();
                    $users = $userController->getUserInfo();
                    ...
                    <div class="col-md-8 col-lg-9">
                      <select class="form-select" aria-label="Default select example" name="teacherid">';
                        ...
                        echo '<option value="' . $users->id . '">' . $users->name . ' ' . $users->surname . '</option>';
                  ...
                  $classController = new classController();
                  $classes = $classController->getClassByTeacher($users->id);
                  echo '<div class="row mb-3">
                ...
                $lessonController = new lessonController();
                $lessons = $lessonController->getLessonByTeacher($users->id);
                echo '<div class="row mb-3">
                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Lesson</label>
                <div class="col-md-8 col-lg-9">


                  <select class="form-select" aria-label="Default select example" name="lessonid">';
              ...
              $examController = new examScoreController();
              $exams = $examController->getExamScoreById($id);
              
              $studentName = $examController->getStudentNameById($exams->student_id);
              
              echo '<div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Student</label>
                  <div class="col-md-8 col-lg-9">
                      <select class="form-select" aria-label="Default select example" name="studentid">
                          <option value="' . $exams->student_id . '">' . $studentName . '</option>
                      </select>
                  </div>
              </div>';
            ...
            $exams = $examController->getExamScoreById($id);
            echo '<div class="row mb-3">
            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Exam Score</label>
            <div class="col-md-8 col-lg-9">
                <input name="examscore" type="text" class="form-control" id="fullName" value="'.$exams->exam_score.'">
            </div>
            </div>';
                    ...
                    ?>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary">Adding Exams</button>
                                    </div>
