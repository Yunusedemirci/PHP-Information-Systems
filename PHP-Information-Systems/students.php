                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                    data-bs-target="#profile-overview">Adding Students</button>
                            </li>

                            <li class="nav-item">
                                <button id="userview" class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#profile-edit">View Students</button>
                            </li>
...
<tbody>';
    ...
    <td><a href="edit.php?id=' . $student->id . '" class="btn btn-primary">Edit</a>
    <a href="delete.php?studentusersid=' . $student->id . '" class="btn btn-danger">Delete</a>
    <a href="detail.php?id=' . $student->id . '" class="btn btn-info">Detail</a>
    <td>
