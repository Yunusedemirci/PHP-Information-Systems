...
if (isset($_POST['name']) && isset($_POST['surname']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['role'])) {
    if (!empty($_POST['name']) && !empty($_POST['surname']) && !empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['role'])) {
        ...
        $role = $_POST['role'];
        $userController->userUpdate($id, $name, $surname, $username, $password, $role);
        $sucsess = true;
    }
}
...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <select name="name" class="form-control" id="fullName" readonly>
                ...
                <div class="col-md-8 col-lg-9">
                    <select name="surname" class="form-control" id="fullName" readonly>
            ...
            <div class="col-md-8 col-lg-9">
                <select name="username" class="form-control" id="fullName" readonly>
...
<div class="row mb-3">
<label for="fullName" class="col-md-4 col-lg-3 col-form-label">Change Password</label>
<div class="col-md-8 col-lg-9">
<input name="password" type="password" class="form-control" id="fullName" value="">
</div>
...
<div class="col-md-8 col-lg-9">
    <select name="role" class="form-control" id="fullName" readonly>
