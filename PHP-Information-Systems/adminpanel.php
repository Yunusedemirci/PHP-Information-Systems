                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>
                                                <?php 
                         $userController = new userController();
                         $studentCount = $userController->getStudentCount();
                         echo $studentCount;  
                          ?>
                                            </h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php 
                      $userController = new userController();
                      $teacherCount = $userController->getTeacherCount();
                      echo $teacherCount;  
                      ?></h6>
                        ...
                        $lessonCount = $lessonController->getLessonCount();
                        echo $lessonCount;
                        ...
                        $classCount = $classController->getClassCount();
                        echo $classCount;
