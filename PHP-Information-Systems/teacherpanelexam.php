...
if (isset($_POST['classid']) && isset($_POST['lessonid']) && isset($_POST['studentid']) && isset($_POST['examscore'])) {
  $classid = $_POST['classid'];
  $lessonid = $_POST['lessonid'];
  $studentid = $_POST['studentid'];
  $examscore = $_POST['examscore'];
  $examController->examAdd($studentid, $lessonid,$classid, $examscore);
  $sucsess = true;
}
    ...
    <main id="main" class="main">
        ...
        <section class="section profile">
            ...
            <div class="col-xl-12">
              ...
              $studentController = new studentController();
              $students = $studentController->getStudentsByClass($classes->id);
              echo '<div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
              <input name="examscore" type="text" class="form-control" id="fullName">
            </div>
          </div>';
