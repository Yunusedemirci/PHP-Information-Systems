        ...
        <nav class="header-nav ms-auto">
            ...
            ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <?php 
                echo '<a  class="dropdown-item d-flex align-items-center" href="teacherprofile.php?id='.$_SESSION["user"]["id"].'"> <i class="bi bi-key-fill"></i>Change Password </a>' ;
              ?>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                   ...
                   $examScoreController = new examScoreController();
                    $average = $examScoreController->avarage();
