...
">
    ...
    <title>Yavuzlar - Information Systems</title>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div class="logo me-auto">
                <h1><a href="index.php">Yavuzlar</a></h1>
            ...
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center"
                    ...
                    <div>
                        ...
                        <h2>Manage your data more easily with information systems
                        </h2>
                        <a href="login.php" class="btn-get-started scrollto">Get Started</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
                    <img src="yavuzlar.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
