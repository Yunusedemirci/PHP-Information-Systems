...
$sucsess = false;
if (isset($_POST['lesson_name']) && isset($_POST['teacher'])) {
    if (!empty($_POST['lesson_name']) && !empty($_POST['teacher'])) {
        $lesson_name = $_POST['lesson_name'];
        $teacher = $_POST['teacher'];
        $lessonController->lessonUpdate($id, $lesson_name, $teacher);
        $sucsess = true;
    }
}
                    ...
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                    data-bs-target="#profile-overview">User Edit</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                echo '<form method="POST" action="lessonedit.php?id='.$id.'">';
                                echo '<div class="row mb-3">
                                <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Lesson Name</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="lesson_name" type="text" class="form-control" id="fullName" value="'.$lesson->lesson_name.'">
                                </div>
                            </div>';
