...
$sucsess = false;
if (isset($_POST['class']) &&  isset($_POST['teacher'])) {
  if(!empty($_POST['class']) && !empty($_POST['teacher'])){
   $class = $_POST['class'];
    $teacher = $_POST['teacher'];
    $classController->add($class,$teacher);
    $sucsess = true;
  }
}
                ...
                <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                    data-bs-target="#profile-overview">Adding Class</button>
                            </li>

                            <li class="nav-item">
                                <button id="userview" class="nav-link" data-bs-toggle="tab"
                                    data-bs-target="#profile-edit">View Classes</button>
                            </li>
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="class" type="text" class="form-control" id="name" value="">
                                        </div>
                                    </div>
                                    <?php 
                  $userController = new userController();
                  ...
                  ?>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary">Adding Class</button>
                                    </div>
                                    <?php
                  if ($sucsess) {
               ...
               $classes = $classController->getClasses();
                if(isset($_POST['search'])){
                  if(!empty($_POST['searchInput'])){
                    ...
                    $classes = $classController->searchClasses($search);
                    ...
                    foreach ($classes as $class) {
                      ...
                      <td>
                        <a href="classedit.php?id=' . $class->id . '" class="btn btn-sm btn-primary">Edit</a>
                        <a href="delete.php?classid=' . $class->id . '" class="btn btn-sm btn-danger">Delete</a>
                        </td>
                    </tr>';
                  }echo '</tbody>
                  </table>';
